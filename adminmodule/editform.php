...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">UPDATE BOOKS <a class="btn btn-default" href="../adminmodule/booklist.php"> See all books </a></h1>
    </div>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
 ...
 <!--       <td><input class="form-control" type="text" name="category" value="<?php echo $category; ?>" required /></td> -->
    ...
    <tr>
        ...
        <a class="btn btn-default" href="../adminmodule/booklist.php"> <span class="glyphicon glyphicon-backward"></span> cancel </a>
