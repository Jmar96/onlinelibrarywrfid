...
<?php
	...
	$stmt = $DB_con->prepare("SELECT * FROM bookrecord WHERE bookTitle = '{$_SESSION['edit_brecord']}' ORDER BY id DESC");
	$stmt->execute();
...
<!--				<img src="../book_images/<?php echo $row['bookPic']; ?>" class="img-rounded" width="250px" height="250px" /> -->
				<p class="page-header"><?php echo "Book ID : &nbsp;" .$bookId."&nbsp;&nbsp;ISBN : &nbsp;&nbsp;".$isbn; ?></p>
				...
				<a class="btn btn-info" href="editbookdata.php?edit_id=<?php echo $row['id']; ?>" title="click for edit" onclick="return confirm('sure to edit ?')"><span class="glyphicon glyphicon-edit"></span> Edit</a> 
